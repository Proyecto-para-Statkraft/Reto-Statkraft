    ...
    if (Thirteenth !== "") {
        return (
            <section>
                ...
                <p>
                    Sin perjuicio de la facultad de STATKRAFT de resolver el Contrato y/o
          ...
          entrega de los Bienes, el <span>PROVEEDOR</span> deberá pagar a{" "}
                ...
                {sectionThirteenth ? <ClauseA companyData={companyData} /> : <ClauseB companyData={companyData} />}
