    ...
    if (Sixth !== "") {
        return (
          ...
          <h3>OCTAVA: PERSONAL DE SUPERVISIÓN</h3>
            ...
            cargas y gravámenes, y a satisfacción de <span>{companyData.name}</span>.
          </p>
                    <p>
                        10.2.2 Que el <span>PROVEEDOR</span> haya entregado a satisfacción
            de <span>{companyData.name}</span> toda la documentación exigida en los Documentos del Contrato. Sin
            perjuicio de esta documentación, el <span>PROVEEDOR</span> deberá
                        entregar los planos y manuales de operación, configuración y mantenimiento de todos los Bienes.
          </p>
                    <p>
