    ...
    if (Fourteenth !== "") {
        return (
            ...
            garantizar que el <span>PROVEEDOR</span> dará fiel cumplimiento al
                                    ...
                                    después de la entrega de los Bienes a satisfacción de
            <span>{companyData.name}</span>.
          </p>
                    <p>
                        14.1.1 Esta carta fianza será ejecutada por{" "}
                        <span>{companyData.name}</span> en caso de resolución del Contrato
            ...
            concepto de penalidades contractuales,{" "}
                        <span>{companyData.name}</span> conservará en su poder el dinero
            ...
            presente Contrato se prevea la entrega de un adelanto a favor del{" "}
                        <span>PROVEEDOR</span>, éste deberá entregar a
            <span>{companyData.name}</span>, en la fecha de suscripción de este
            ...
            satisfacción de <span>{companyData.name}</span>.
                    ...
                    <p>
                        ...
                        presente Contrato con el número o código interno que le asigne
            <span>{companyData.name}</span>. Caso contrario,{" "}
                        <span>{companyData.name}</span> podrá rechazar la recepción de las
                        garantías.
          </p>
                    <p>
