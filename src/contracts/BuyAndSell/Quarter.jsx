...
const Quarter = ({ companyData, exchangeRate }) => (
    <section>
        ...
        <p>
            ...
            Contrato al <span>PROVEEDOR</span>, en {exchangeRate}, mediante depósito o transferencia 
            ...
            elección de <span>{companyData.name}</span>. En el caso Bienes cotizados en Dólares de los 
            Estados Unidos de América, al momento de la facturación se considerará, a elección de 
            <span>{companyData.name}</span>, el pago en dicha moneda en moneda nacional, Nuevo Sol, al 
            tipo de cambio compra que tenga vigente la SBS para esa fecha.
        </p>
        <p>
