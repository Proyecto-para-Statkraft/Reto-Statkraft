...
const Clause = ({ companyData, money }) => (
    <section>
        <p>
            14.1.2 Póliza de Responsabilidad Civil Extracontractual por un monto no menor a US$ {money.quantity}
            ({money.quantityText} y 00/100 Dólares de los Estados Unidos de América) para amparar cualquier
