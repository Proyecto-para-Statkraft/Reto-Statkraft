...
const Clause = ({ companyData }) => (
    <section>
        ...
        <p>
            El <span>PROVEEDOR</span>, se obliga a realizar todas las prestaciones relacionadas a
        ...
        <p>
            El <span>PROVEEDOR</span> se asegurará que sus afiliados, empleados, agentes autorizados u otros
            representantes que realicen los Servicios en nombre de el <span>PROVEEDOR</span> cumplan con todos
            los requisitos mencionados anteriormente.
        </p>
        <p>
            1.2 El <span>PROVEEDOR</span> notificará por escrito y de manera inmediata a {companyData.name} si existen
            razones para creer que el <span>PROVEEDOR</span> o cualquiera de sus representantes o subcontratistas
        ...
        <p>
            1.3 Si {companyData.name} sospecha razonablemente que el <span>PROVEEDOR</span> ha violado alguno de los requisitos
        ...
        <p>
            ...
            también tendrá derecho a exigir al <span>PROVEEDOR</span> que implemente acciones correctivas razonables
        ...
        <p>
            1.5 En caso de incumplimiento por parte del <span>PROVEEDOR</span> de las disposiciones de la Cláusula 1.1,
            o si el <span>PROVEEDOR</span> o cualquiera de sus afiliados, representantes o subcontratistas es adquirida,
        ...
        <ul>
            <li>
                ...
                incumplimiento se puede remediar pero el <span>PROVEEDOR</span> no ha solucionado el incumplimiento
            ...
            <li>
                ii. El <span>PROVEEDOR</span> deberá indemnizar a {companyData.name} contra cualquier pérdida, responsabilidad,
        ...
        <p>
            1.6 Antes de celebrar cualquier subcontratación, el <span>PROVEEDOR</span> llevará a cabo una debida
            ...
            el <span>PROVEEDOR</span> o {companyData.name};
        </p>
        <p>
        ...
        <ul>
            ...
            <li>
                ii. Proporcionen a el <span>PROVEEDOR</span> y {companyData.name} documentación e información de
                los Subcontratistas de acuerdo con los principios de la Cláusula 1.3 antes mencionada; y
            </li>
            <li>
        ...
        <p>
            ...
            Subcontratistas como si fuesen actos, incumplimientos y negligencias del <span>PROVEEDOR</span>.
        </p>
    </section>
);
