...
const Clause = ({ companyData, annexed }) => (
    <section>
        ...
        <p>
            [El Proveedor], se obliga a realizar todas las prestaciones relacionadas a la
        ...
        <ul>
            ...
            <li>
                vi. El Código de conducta de [El Proveedor] de <span>{companyData.name}</span> adjunto como Anexo
                {annexed.codeConduct} al Contrato; y
            </li>
            <li>
        ...
        <p>
            [El Proveedor] se asegurará que sus afiliados, representantes, subcontratistas
            empleados, agentes autorizados u otros representantes que realicen los Servicios
            en nombre de [El Proveedor] cumplan con todos los requisitos mencionados anteriormente.
        </p>
        <p>
            [El Proveedor] garantiza, salvo haya comunicado lo contrario a <span>{companyData.name}</span> antes 
            de la suscripción del Contrato, que según su leal saber y entender, ni [El Proveedor],
        ...
        <p>
            [El Proveedor] además declara y garantiza que, en relación con el proceso de compras,
        ...
        <p>
            [El Proveedor] se obliga a cumplir con los requisitos del punto [1.1], incluida
        ...
        <p>
            [El Proveedor] se obliga a mantener libros, cuentas y registros detallados y
            ...
            tiempo y los gastos en relación con este Contrato. [El Proveedor] deberá mantener
        ...
        <p>
            Si [El Proveedor] tiene conocimiento de un posible incumplimiento de los requisitos
            de la Cláusula [1.1], [El Proveedor] deberá informarlo de inmediato a <span>{companyData.name}</span> por
            escrito.
        </p>
        <p>
            Si [El Proveedor] ha informado de un posible incumplimiento a <span>{companyData.name}</span> o 
        ...
        <ul>
            ...
            <li>
                (ii) [El Proveedor] otorgará a <span>{companyData.name}</span> o su representante externo mediante un
                aviso en horario normal de trabajo, acceso completo y sin restricciones a cualquier
                ...
                cualquier solicitud razonable de [El Proveedor] con respecto al momento en la que se
                llevará a cabo la auditoria y otros aspectos prácticos;
            </li>
            <li>
                (iii) [El Proveedor], dentro de un tiempo razonable después de haber recibido el requerimiento
                ...
                de [El Proveedor],  correos electrónicos, consultas o correspondencia enviada en
                ...
                cualquier información de carácter confidencial recibida de parte de [El Proveedor], a
                ...
                de auditar a [El Proveedor] hasta después de (2) dos años de terminado el Contrato
            </li>
            <li>
                (iv) <span>{companyData.name}</span> puede requerir una suspensión de los Servicios a [El Proveedor], 
                durante un período razonable mientras se realicen las investigaciones y auditorías, sin que 
                ello implique la ampliación del plazo para que el Proveedor realice los Servicios o solicite 
            ...
            <li>
                (v) <span>{companyData.name}</span> puede exigir al Proveedor que implemente acciones correctivas 
        ...
        <p>
            En caso de incumplimiento por parte de [El Proveedor] de las disposiciones de la Cláusula [1.1], 
            o si [El Proveedor] o cualquiera de sus Afiliados, Representantes o Subcontratistas se convierte 
        ...
        <ul>
            <li>
                ...
                se puede remediar pero [El Proveedor] no ha solucionado el incumplimiento dentro de un período 
            ...
            <li>
                (ii) [El Proveedor] deberá indemnizar a <span>{companyData.name}</span> contra cualquier pérdida, daños, 
                costos y gastos (incluidos los honorarios legales) incurridos o sufridos por <span>{companyData.name}</span> 
                como consecuencia de dicho incumplimiento.
            </li>
        </ul>
        <p>1.4 REPRESENTANTES Y SUBCONTRATISTAS</p>
        <p>
            Antes de celebrar cualquier subcontrato, [El Proveedor] llevará a cabo una debida diligencia 
            ...
            otro para [El Proveedor] o <span>{companyData.name}</span>;
        </p>
        <p>
        ...
        <p>
            [El Proveedor] revisará la efectividad del sistema y programa de control interno de los 
        ...
        <p>
            ...
            ubcontratistas como si fueran los actos, incumplimientos y negligencias de [El Proveedor].
        </p>
    </section>
);
