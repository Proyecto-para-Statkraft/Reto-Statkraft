...
const Third = ({ data, Third }) => {
    ...
    if (Third !== "") {
        return (
            ...
            la suma de {moneys} más el Impuesto General a
            ...
            el <span>PROVEEDOR</span> renuncia a presentar cualquier reclamo por la información
                ...
                {(clause35) ? <Clause companyData={companyData} /> : <p> 3.5 (Cláusula Intencionalmente dejada en blanco por las partes)</p>
                }
            </section>
        )
    }
